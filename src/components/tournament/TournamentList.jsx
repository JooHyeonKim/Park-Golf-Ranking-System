        ...
        <div className="flex justify-between items-center mb-6 sm:mb-8">
          ...
          <div className="flex gap-2">
            ...
            {isAuthenticated ? (
              <button
                onClick={onProfile}
                className="px-4 py-2 sm:px-5 sm:py-2.5 rounded-full font-bold transition-all text-xs sm:text-sm bg-gradient-to-r from-gray-500 to-gray-600 text-white hover:from-gray-600 hover:to-gray-700"
              >
                👤 {displayName || '프로필'}
              </button>
            ) : (
            ...
            <div className="mb-4">
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  className="w-5 h-5 rounded-full border border-gray-400 text-gray-500 text-xs font-bold flex items-center justify-center hover:bg-gray-100 transition-colors leading-none"
                >
                  ?
                </button>
              </div>
